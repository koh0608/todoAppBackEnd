...
var StaffEntity = /** @class */ (function (_super) {
    ...
    /* ---------------------------------- Hooks --------------------------------- */
    StaffEntity.hashPassword = function (instance) {
    ...
    __decorate([
        sequelize_typescript_1.Column
    ], StaffEntity.prototype, "contactNo");
    __decorate([
        sequelize_typescript_1.Column
    ...
    __decorate([
        ...
        sequelize_typescript_1.Column
    ], StaffEntity.prototype, "fullAccess");
    __decorate([
        (0, sequelize_typescript_1.AllowNull)(false),
        (0, sequelize_typescript_1.Default)(true),
        sequelize_typescript_1.Column
    ], StaffEntity.prototype, "active");
    __decorate([
        (0, sequelize_typescript_1.ForeignKey)(function () { return user_entity_1.UserEntity; }),
        sequelize_typescript_1.Column
    ], StaffEntity.prototype, "createdBy");
    __decorate([
        (0, sequelize_typescript_1.ForeignKey)(function () { return user_entity_1.UserEntity; }),
        sequelize_typescript_1.Column
    ], StaffEntity.prototype, "updatedBy");
    __decorate([
        (0, sequelize_typescript_1.ForeignKey)(function () { return user_entity_1.UserEntity; }),
        sequelize_typescript_1.Column
    ], StaffEntity.prototype, "deletedBy");
    __decorate([
    ...
    __decorate([
        sequelize_typescript_1.Column
    ], StaffEntity.prototype, "deletedAt");
    __decorate([
        (0, sequelize_typescript_1.BelongsTo)(function () { return user_entity_1.UserEntity; }, 'createdBy')
    ], StaffEntity.prototype, "creator");
    __decorate([
        sequelize_typescript_1.BeforeUpdate,
        sequelize_typescript_1.BeforeCreate
    ], StaffEntity, "hashPassword");
    StaffEntity = __decorate([
        (0, sequelize_typescript_1.Table)({ paranoid: true, tableName: 'staffs', underscored: true })
    ], StaffEntity);
    return StaffEntity;
